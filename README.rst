...
**Figures is in early stage development**
...
Figures is a reporting and data retrieval app. It plugs into the edx-platform LMS app server. Its goals are twofold:

* Fill gaps in Open edX reporting and analytics to meet community needs
* Provide a clear and intuitive user interface

To evolve Figures to meet community needs, we are keeping in mind as principles the following features, which Jill Vogel outlined in her post on ed Xchange:
