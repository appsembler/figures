...
from figures.views import LearnerMetricsViewSetV2
...
@pytest.mark.skip(reason='We need to add EnrollmentData mock records')
@pytest.mark.django_db
class TestLearnerMetricsViewSetV2(BaseViewTest):
    ...
    view_class = LearnerMetricsViewSetV2

    @pytest.fixture(autouse=True)
    def setup(self, db, settings):
        if organizations_support_sites():
            settings.FEATURES['FIGURES_IS_MULTISITE'] = True
        super(TestLearnerMetricsViewSetV2, self).setup(db)
